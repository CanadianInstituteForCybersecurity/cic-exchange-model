...
class VisitorIndexedOctetString(opendnp3.IVisitorIndexedOctetString):
    def __init__(self):
        super(VisitorIndexedOctetString, self).__init__()
        self.index_and_value = []

    def OnValue(self, indexed_instance):
        value = indexed_instance.value
        max_size = value.MAX_SIZE
        self.index_and_value.append((indexed_instance.index, (max_size)))